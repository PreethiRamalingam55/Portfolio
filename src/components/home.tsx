...
export default function Home() {
  return (
    <div
      data-aos="fade-in"
      className="w-full dark:bg-gradient-to-r from-darkprimary/20 to-darksecondary h-screen"
    >
      <div className="relative container flex flex-col md:flex-row justify-center items-center md:gap-32">
        ...
        <div className="container flex flex-col justify-center md:h-screen order-1 md:order-2">
          <h1
            data-aos="fade-in"
            className="mt-20 md:mt-0 text-xl md:text-3xl my-3"
          >
            Hello, I am
          </h1>
          <h2 data-aos="fade-in" className="text-3xl md:text-6xl ">
            Varun{" "}
            <span className="text-gradient dark:text-gradient font-bold">
              Raja
            </span>
          </h2>
          <h3 className="text-3xl md:text-6xl my-3 ">
            And{" "}
            <span className="text-gradient dark:text-gradient font-bold">
              I'm
            </span>
          </h3>
          <div data-aos="fade-in" className="text-3xl md:text-6xl my-3 text-gradient dark:text-gradient font-bold leading-normal">
            {/* <Typewriter
                options={{
