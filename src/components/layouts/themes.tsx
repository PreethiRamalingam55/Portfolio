...
export default function ThemeSwitcher({ handleCloseMenu }: any) {
    ...
    <div>
      ...
      >
        ...
        <span className="absolute  moon animate-keyframes-fill">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" fill="currentColor"> {/* Change fill to "currentColor" for dynamic color */}
