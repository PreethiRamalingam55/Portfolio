  ...
  return (
    ...
    >
      <div className={"innerSticky fixed top-0 z-[1000] w-full"}>
        <div
          className="absolute right-32 top-10 border-[1px] border-textcolor rounded-full w-[55px] h-[55px] p-5 flex flex-col gap-3 items-center justify-center group hover:border-primary dark:hover:border-darkprimary"
          onClick={handleMenuToggle}
        >
          <div className="w-[20px] h-[2px] block bg-white group-hover:bg-primary dark:group-hover:bg-darkprimary"></div>
          <div className="w-[20px] h-[2px] block bg-white group-hover:bg-primary dark:group-hover:bg-darkprimary"></div>
        </div>
        <nav className="absolute right-32 top-44">
